                                ...
                                Positioned(
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: FloatingActionButton(
                                      onPressed: () {
                                        Get.back() ;
                                        (CartController.commande.restaurant==name && CartController.commande.plats.isNotEmpty) ?
                                            null :  controller.Reinitialize(category)  ;
                                      },
                                      child: Icon(
                                        Icons.arrow_back,
                                        color: Colors.black,
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Container(
                                                                            height: 300.h,
                                                                            width: 281.w,
                                                                            child: Food(image: cat.plat[index].image, name: cat.plat[index].name, prix: cat.plat[index].prix, List_of_food: List_of_food, description: 'Fromage, Poulet, Sauce Fromage', ajouter: cat.plat[index].ajouter, nom_restaurant: name  )
                                                                        ),
                                          ...
                                          child:  GetX<RestaurantScreen_controller>(
                                            ...
                                            builder: (controller){
                                              return  ElevatedButton(
                                                  ...
                                                  onPressed:( ( CartController.commande.plats.isNotEmpty)|| List_of_food.isNotEmpty)  ?() {
                                                   controller.onPressed(List_of_food, name, adress) ;
                                                      }:null ,
